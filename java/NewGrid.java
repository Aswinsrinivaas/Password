 ...
 * @author Crisp
 */
public class NewGrid extends javax.swing.JFrame {
...
String slider=null;
String phone=null;
String mail,pinnumber,PassKey=null;
 Connection con;
    /**
...
try {
           ...
           smt = con.createStatement();
            ...
            int query=0;
                   ...
                   query=smt.executeUpdate("update register set  grid='"+jPasswordField1.getText()+"'where id='"+g+"'");
                  if(query==1){
...
public void msg(){
    ...
    try{
   ResultSet rs=smt1.executeQuery("select username,password,phoneno,mailid,imagepixelx,imagepixely,pinnumber,slidercount,grid from register where id='"+g+"' ");
   while(rs.next()){
       ...
       PassKey=rs.getString("grid");
   }
   
 SMS s=new SMS();
        s.SendSMS(phone,"UserName: "+uname+"\nPassword: "+pass+"\nImagePixelX: "+image1+"\nImagePixelY: "+image2+"\npinnumber: "+pinnumber+"\nSliderCount: "+slider+"\nPassKey: "+PassKey);
